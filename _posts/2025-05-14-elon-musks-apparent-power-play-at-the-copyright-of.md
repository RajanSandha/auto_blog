...
- mobile
- programming
excerpt: What initially appeared to be a power play by Elon Musk and the Department
  of Government Efficiency (DOGE) to take over the US Copyright Office by having Donald
toc: true
toc_sticky: true
classes: wide
header:
