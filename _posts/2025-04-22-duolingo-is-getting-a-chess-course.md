...
- security
- data
excerpt: 'Duolingo will soon be able to help you learn another new skill: chess. The
  platform’s new chess course will use short puzzles, such as moving a knight to the
  co'
header:
